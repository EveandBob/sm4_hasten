...
uint32_t plaintext2[] = { 0x01234567,0x89abcdef,0xfedcba98,0x76543210,
...
#define x_point int*
#define aaaaa 630866461
uint32_t plaintext[(aaaaa + 3) / 4];
uint32_t ciphertext_32_for_thread[sizeof(plaintext)/ sizeof(int)];
uint32_t ciphertext_32 [sizeof(plaintext) / sizeof(int)];
#include<fstream>

void get_plaintext() {
    fstream f;
    f.open("C:\\Users\\13052\\Desktop\\video.txt", ios::in | ios::binary | ios::ate);
    int size = f.tellg();
    f.seekg(0, ios::beg);

    f.read((char*)plaintext, aaaaa);
    f.close();
 
    cout <<hex <<sizeof(plaintext) << " " << plaintext[(aaaaa + 3) / 4-1];
}
//s盒变换
...
//T盒变换
uint32_t T_replace(uint8_t in, uint32_t* box)
{
    uint8_t xcoor = in >> 4;
    uint8_t ycoor = in << 4;
    ycoor = ycoor >> 4;
...
void encryption_open_cycle(uint32_t* ciphertext, uint32_t* plaintext_for_one_round) {
    uint32_t X[36] = { 0 };
    X[0] = plaintext_for_one_round[0]; X[1] = plaintext_for_one_round[1]; X[2] = plaintext_for_one_round[2]; X[3] = plaintext_for_one_round[3];  
    X[4] = X[0] ^ T_for_roundfunc_func(X[1] ^ X[2] ^ X[3] ^ rK[0]);
    X[5] = X[1] ^ T_for_roundfunc_func(X[2] ^ X[3] ^ X[4] ^ rK[1]);
    X[6] = X[2] ^ T_for_roundfunc_func(X[3] ^ X[4] ^ X[5] ^ rK[2]);
    X[7] = X[3] ^ T_for_roundfunc_func(X[4] ^ X[5] ^ X[6] ^ rK[3]);
    X[8] = X[4] ^ T_for_roundfunc_func(X[5] ^ X[6] ^ X[7] ^ rK[4]);
    X[9] = X[5] ^ T_for_roundfunc_func(X[6] ^ X[7] ^ X[8] ^ rK[5]);
    X[10] = X[6] ^ T_for_roundfunc_func(X[7] ^ X[8] ^ X[9] ^ rK[6]);
    X[11] = X[7] ^ T_for_roundfunc_func(X[8] ^ X[9] ^ X[10] ^ rK[7]);
    X[12] = X[8] ^ T_for_roundfunc_func(X[9] ^ X[10] ^ X[11] ^ rK[8]);
    X[13] = X[9] ^ T_for_roundfunc_func(X[10] ^ X[11] ^ X[12] ^ rK[9]);
    X[14] = X[10] ^ T_for_roundfunc_func(X[11] ^ X[12] ^ X[13] ^ rK[10]);
    X[15] = X[11] ^ T_for_roundfunc_func(X[12] ^ X[13] ^ X[14] ^ rK[11]);
    X[16] = X[12] ^ T_for_roundfunc_func(X[13] ^ X[14] ^ X[15] ^ rK[12]);
    X[17] = X[13] ^ T_for_roundfunc_func(X[14] ^ X[15] ^ X[16] ^ rK[13]);
    X[18] = X[14] ^ T_for_roundfunc_func(X[15] ^ X[16] ^ X[17] ^ rK[14]);
    X[19] = X[15] ^ T_for_roundfunc_func(X[16] ^ X[17] ^ X[18] ^ rK[15]);
    X[20] = X[16] ^ T_for_roundfunc_func(X[17] ^ X[18] ^ X[19] ^ rK[16]);
    X[21] = X[17] ^ T_for_roundfunc_func(X[18] ^ X[19] ^ X[20] ^ rK[17]);
    X[22] = X[18] ^ T_for_roundfunc_func(X[19] ^ X[20] ^ X[21] ^ rK[18]);
    X[23] = X[19] ^ T_for_roundfunc_func(X[20] ^ X[21] ^ X[22] ^ rK[19]);
    X[24] = X[20] ^ T_for_roundfunc_func(X[21] ^ X[22] ^ X[23] ^ rK[20]);
    X[25] = X[21] ^ T_for_roundfunc_func(X[22] ^ X[23] ^ X[24] ^ rK[21]);
    X[26] = X[22] ^ T_for_roundfunc_func(X[23] ^ X[24] ^ X[25] ^ rK[22]);
    X[27] = X[23] ^ T_for_roundfunc_func(X[24] ^ X[25] ^ X[26] ^ rK[23]);
    X[28] = X[24] ^ T_for_roundfunc_func(X[25] ^ X[26] ^ X[27] ^ rK[24]);
    X[29] = X[25] ^ T_for_roundfunc_func(X[26] ^ X[27] ^ X[28] ^ rK[25]);
    X[30] = X[26] ^ T_for_roundfunc_func(X[27] ^ X[28] ^ X[29] ^ rK[26]);
    X[31] = X[27] ^ T_for_roundfunc_func(X[28] ^ X[29] ^ X[30] ^ rK[27]);
    ciphertext[3] = X[32] = X[28] ^ T_for_roundfunc_func(X[29] ^ X[30] ^ X[31] ^ rK[28]);
    ciphertext[2] = X[33] = X[29] ^ T_for_roundfunc_func(X[30] ^ X[31] ^ X[32] ^ rK[29]);
    ciphertext[1] = X[34] = X[30] ^ T_for_roundfunc_func(X[31] ^ X[32] ^ X[33] ^ rK[30]);
    ciphertext[0] = X[35] = X[31] ^ T_for_roundfunc_func(X[32] ^ X[33] ^ X[34] ^ rK[31]);
}

//轮函数中的T函数查表优化
uint32_t T_for_roundfunc_use_Tbox_func(uint32_t K_for_t) {
    uint8_t* A = (uint8_t*)&K_for_t;
    return  Table0[A[3]] ^ Table1[A[2]] ^ Table2[A[1]] ^ Table3[A[0]];
}
//输出结果
static void dump_buf(uint32_t* ciphertext_32,int lenth)
{
    int j;
    printf("加密结果为：");
    uint8_t* ciphertext_4;
    for (int i = 0; i < lenth; i++) {
        ciphertext_4 = (uint8_t*)&ciphertext_32[i];
        for (j = 0; j < 4; j++) {
            printf("%02X ", ciphertext_4[4 - 1 - j]);
        }
...
void SM4_ECB() {
    ...
    uint32_t* point_plaintext = new uint32_t(4);
    uint32_t* point_ciphertext = new uint32_t(4);
    for (int i = 0; i < sizeof(plaintext) / sizeof(int); i += 4) {
        uint32_t* point_plaintext = &plaintext[i];
        uint32_t* point_ciphertext =&ciphertext_32[i];
        encryption(point_ciphertext, point_plaintext);
    }
}

//循环展开SM4 ECB
void SM4_ECB_open_cycle() {
    //获取轮密钥
    uint32_t K[36];
    K[0] = MK[0] ^ FK[0]; K[1] = MK[1] ^ FK[1]; K[2] = MK[2] ^ FK[2]; K[3] = MK[3] ^ FK[3];
    for (int i = 4; i < 36; i++) {
    ...
    for (int i = 0; i < sizeof(plaintext) / sizeof(int); i += 4) {
        ...
        uint32_t* point_ciphertext = &ciphertext_32[i];
        //加密算法中无求轮密钥的步骤
        encryption_open_cycle(point_ciphertext, point_plaintext);
    }
 }
//SM4 ECB模式下的使用多线程的方法。
void SM4_ECB_for_thread(int num) {
    //每一轮的明文
    uint32_t* point_plaintext = new uint32_t(4);
    uint32_t* point_ciphertext = new uint32_t(4);
    for (int i = num*4; i < sizeof(plaintext) / sizeof(int); i += 4*8) {
        uint32_t* point_plaintext = &plaintext[i];
        uint32_t* point_ciphertext = &ciphertext_32[i];
        encryption(point_ciphertext, point_plaintext);
    }
...
__m256i SIMD_T_func(__m256i R) {
    ...
    R_s0 = _mm256_i32gather_epi32((int*)BOX0, R_s0, 4);
    R_s1 = _mm256_i32gather_epi32((int*)BOX1, R_s1, 4);
    R_s2 = _mm256_i32gather_epi32((int*)BOX2, R_s2, 4);
    R_s3 = _mm256_i32gather_epi32((int*)BOX3, R_s3, 4);
...
void SM4_ECB_for_SIMD() {
    ...
    uint32_t* point_plaintext = new uint32_t(32);
    uint32_t* point_ciphertext = new uint32_t(32);
    for (int i = 0; i < sizeof(plaintext) / sizeof(int); i += 32) {
        uint32_t* point_plaintext = &plaintext[i];
        uint32_t* point_ciphertext = &ciphertext_32[i];
        encryption_SIMD(point_ciphertext, point_plaintext);
    }
}
//SM4 ECB模式下的使用T表查询的方法。
void SM4_ECB_use_T_box() {
    //每一轮的明文
    uint32_t K[36];
    K[0] = MK[0] ^ FK[0]; K[1] = MK[1] ^ FK[1]; K[2] = MK[2] ^ FK[2]; K[3] = MK[3] ^ FK[3];
    for (int i = 4; i < 36; i++) {
    ...
    for (int i = 0; i < sizeof(plaintext) / sizeof(int); i += 4) {
        uint32_t* point_plaintext = &plaintext[i];
        uint32_t* point_ciphertext = &ciphertext_32[i];
        encryption_use_t_box(point_ciphertext, point_plaintext);
    }
}
